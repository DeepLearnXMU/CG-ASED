...
from model.parser_future import ParserFuture
from model.parser_past import ParserPast
from model.parser_tree import ParserTree
...
def train(args):
    ...
    while True:
        ...
        for batch_examples in train_set.batch_iter(batch_size=args.batch_size, shuffle=True):
            ...
            # warm up
            # args.warm_up_step = 200
            # if train_iter < args.warm_up_step:
            #     lr = args.lr * (train_iter / float(args.warm_up_step))
            #     print('learning rate to %f' % lr, file=sys.stderr)
            #     # set new lr
