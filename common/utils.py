...
def init_arg_parser():
    ...
    arg_parser.add_argument('--pos_max', default=3, type=int, help='position max')
    arg_parser.add_argument('--alpha', default=0.0, type=float, help='alpha')
    arg_parser.add_argument('--future_dp', default=0.0, type=float, help='dropout rate of future module')
    arg_parser.add_argument('--past_dp', default=0.0, type=float, help='dropout rate of past module')
